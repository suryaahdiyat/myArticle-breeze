...
Route::post('/post/toggle-like', [LikeController::class, 'toggleLike'])->middleware('can:crud like');

Route::resource('/comments', CommentController::class)->middleware('can:crud comment');
Route::resource('/users', UserController::class)->middleware('can:crud user');
